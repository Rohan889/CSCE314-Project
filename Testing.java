...
public class Testing {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //part 1
        Driver Driver = new Driver("PT1.txt", "YT1.txt"); // new instance of driver, provide names of files in constructor
        Driver.readFiles();
    ...
    public static void testWriteListEqual(String filePath) throws IOException {
        ...
        if(!testIsPresent("otherwise\t\t1","resultsListEqual.txt")){
            System.out.println("resultsListEqual.txt missing words that are equal in both texts1");
            pass = 0;
        }
    ...
    public static void testWriteEqual(String filePath) throws IOException {
        ...
        if(!testIsPresent("otherwise\t\t1","resultsEqual.txt")){
            System.out.println("resultsEqual.txt missing words that are equal in both texts1");
            pass = 0;
        }
